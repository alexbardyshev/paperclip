...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: "Головна", icon: House },
      { type: "link", to: "/issues", label: "Задачі", icon: CircleDot },
      { type: "action", label: "Створити", icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: "Агенти", icon: Users },
      {
        type: "link",
        to: "/inbox",
        label: "Вхідні",
